...
export class CanvasManager {
    ...
    private _densityAutoParticles(): void {
        ...
        if (particles.number.density.enable) {
            ...
            const nb_particles: number = area * particles.number.value / particles.number.density.value_area;

            const missing_particles: number = particles.array.length - nb_particles;
